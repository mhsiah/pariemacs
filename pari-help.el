...
(defun gp-browser-2-select nil
  ...
  (gp-call-gphelp (window-width (get-buffer-window gp-function-description-buffer-name))
                  (thing-at-point 'word) gp-function-description-buffer-name "-detex")
  ;; Replace ESC[.?m by nothing: (\033 or \e)
  (set-buffer gp-function-description-buffer-name)
  (gp-replace "\033\\[.?m" ""))
