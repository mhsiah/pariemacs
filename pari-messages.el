  ...
  '((francais  .
      ("Nous utilisons le choix par defaut pour la completion"  ;; no 1
       ...
       "Ce nouveau prompt peut conduire a une erreur. Mieux vaut le changer via M-\\p"  ;; no 10
        ...
        ""                         ;; no 12
        ""                      ;; no 13
        "Echange les fonctions des touches C-p/M-p and C-n/M-n." ;; no 14
        "gp essaie de completer ..."                  ;; no 15
        "C-u M-o pour sortir de l'edition."           ;; no 16
        "Lancement de "                               ;; no 17
        "SPC=suivant DEL=precedent RET=selectionner s=survey-menu q=quitter" ;; no 18
        ...
        "Lire le fichier..." ;; no 49 "Read from File..."
        ...
        "Lancer GP"      ;; no 57
        "Avec l'heure precise"      ;; no 58 "With Precise Time"
        ""  ;; no 59
        ...
        "La derniere ligne etait : "            ;; no 70 "Last line was: "
        ...
        "Pas d'historique a ce niveau" ;; no 86
        "Cette entree est verrouillee. Continuez ici" ;; no 87
        "Historique" ;; no 88
        "Commande precedente" ;; no 89
     ...
     (english .
       ("Using default choice for completion"            ;; no 1
        ...
        "Lock semi-mode %s" ;; no 84
        "Trust semi-mode %s" ;; no 85
        "No history recall here" ;; no 86
        "This entry is locked. Proceed here." ;; no 87
        "History" ;; no 88
        "Previous command" ;; no 89
        "Next command" ;; no 90
        "Change keys"              ;; no 91
